...
void help_commands(void) {
    ...
    eris_printf(ERIS_LOG_CMD, "  alias add <name> <cmd> and <cmd> ...  Add macro (do = ;  and = &&  or = ||)\n");
    ...
    eris_printf(ERIS_LOG_CMD, "  merge [branch]          Merge updated base into branch (default: current)\n\n");
